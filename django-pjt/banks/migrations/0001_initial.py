    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('save_trm6', models.FloatField(blank=True, null=True)),
                ('save_trm12', models.FloatField(blank=True, null=True)),
                ('save_trm24', models.FloatField(blank=True, null=True)),
                ('save_trm36', models.FloatField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='FilteringSavingOptions',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kor_co_nm', models.TextField()),
                ('fin_prdt_nm', models.TextField()),
